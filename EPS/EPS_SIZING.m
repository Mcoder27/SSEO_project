...
P_e = (1054.8 + 70.1) * 1.2; % Power requested during eclipse (value found)
P_s = 1054.8 * 1.2; % Power rquested during sunlight (value found)
T_e = 1475; % Eclipse time (know I will find it)
T_s = (5550-T_e); % Sunlight time (know I will find it)
X_e = 0.65; % Lines efficiency in eclipse (DET 0.65 MPPT 0.60)
X_s = 0.85; % Lines efficiency in sunlight (DET 0.85 MPPT 0.80)

P_sa = ((P_e*T_e)/X_e + (P_s*T_s)/X_s) / T_s;

%% SOLAR PANELS SIZING
epsilon = 0.27; % Solar cell efficiency (0.3)
P0 = 1324; % Solar radiation (value given)
I_d = 0.8; % inherent degradation factor (0.5-0.9)
theta = pi/6; % Sun incidence angle (know I will find it), (orientation factor 0.88)
dpy = 0.03; % yearly degradation factor (0.03)
years = 3.25; % Expected mission lifetime in years (value found)
...
N_batt = 2; % Number of batteries (2-5)
DoD = 0.3; % Depth of discharge (30%-50%) (30 for high number of cycles)
nu_eol = 0.75; % End of life efficiency (Probabily to assume)
